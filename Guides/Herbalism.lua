...
step << Mage
    ...
    .zone Dalaran >> Teleport to Dalaran
step << !Mage
    .goto Shattrath City,55.7,37.0 >> Fly back to Shattrath and take the portal to Stormwind
...
step
    #completewith next
    .goto Stormwind City,18.5,26.3 >> Get to Borean Tundra by ship or talk to Leesha Tennerby to get transported right away
    .skill herbalism,400,1
    .zoneskip Borean Tundra
step
    #label Kirea
...
step
    #completewith next
    .goto Dalaran,72.4,45.7
    .fly K3 >> Fly to The Storm Peaks (K3)
    .zoneskip The Storm Peaks
    .skill herbalism,450,1
    .skill riding,300,1
step
